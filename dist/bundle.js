...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom */ \"./src/dom.js\");\n/* harmony import */ var _createProject__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./createProject */ \"./src/createProject.js\");\n/* harmony import */ var _createTodoList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./createTodoList */ \"./src/createTodoList.js\");\n/* harmony import */ var _addTodo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./addTodo */ \"./src/addTodo.js\");\n/* harmony import */ var _submit__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./submit */ \"./src/submit.js\");\n // import { format } from 'date-fns';\n\n\n\n\n\n\nvar projects = [];\n\nfunction pushToDom() {\n  var projectItemsList = _dom__WEBPACK_IMPORTED_MODULE_1__.myQuery('.project-items-list');\n  projectItemsList.innerHTML = '';\n  projects.forEach(function (project) {\n    projectItemsList.append((0,_createProject__WEBPACK_IMPORTED_MODULE_2__.default)(project));\n    var projectButton = _dom__WEBPACK_IMPORTED_MODULE_1__.myQuery('.project-btn');\n    projectButton.addEventListener('click', function () {\n      if (project.todoList.length > 0) {\n        var ul = _dom__WEBPACK_IMPORTED_MODULE_1__.myQuery('.todo-items-list'); // ul.innerHTML = '';\n\n        ul.appendChild((0,_createTodoList__WEBPACK_IMPORTED_MODULE_3__.default)(project.todoList));\n      }\n    });\n    (0,_submit__WEBPACK_IMPORTED_MODULE_5__.default)(project);\n  });\n}\n\nvar addProject = _dom__WEBPACK_IMPORTED_MODULE_1__.myQuery('.new-project-btn');\naddProject.addEventListener('click', function (e) {\n  e.preventDefault();\n  var projectName = _dom__WEBPACK_IMPORTED_MODULE_1__.myQuery('#new-project').value;\n  var project = {\n    name: projectName,\n    todoList: [],\n    id: 0\n  };\n  projects.push(project);\n  pushToDom();\n});\n\n//# sourceURL=webpack://JS_ToDoList/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dom */ \"./src/dom.js\");\n\n\nvar todoItem = function todoItem(title, description, dueDate, priority, ID) {\n  var itemTitle = title;\n  var itemDescription = description;\n  var itemDueDate = dueDate;\n  var itemPriority = priority;\n  var itemID = ID;\n  return {\n    itemTitle: itemTitle,\n    itemDescription: itemDescription,\n    itemDueDate: itemDueDate,\n    itemPriority: itemPriority,\n    itemID: itemID\n  };\n};\n\nfunction submitButton(project) {\n  var submitBtn = _dom__WEBPACK_IMPORTED_MODULE_0__.myQuery('.submit-btn');\n  submitBtn.addEventListener('click', function (todoData) {\n    todoData.preventDefault();\n    var title = _dom__WEBPACK_IMPORTED_MODULE_0__.myQuery('#title').value;\n    var description = _dom__WEBPACK_IMPORTED_MODULE_0__.myQuery('#description').value;\n    var dueDate = _dom__WEBPACK_IMPORTED_MODULE_0__.myQuery('#due-date').value;\n    var priority = _dom__WEBPACK_IMPORTED_MODULE_0__.myQuery('#priority').value;\n    var newTodoItem = todoItem(title, description, dueDate, priority);\n    console.log(project);\n  });\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (submitButton);\n\n//# sourceURL=webpack://JS_ToDoList/./src/submit.js?");
