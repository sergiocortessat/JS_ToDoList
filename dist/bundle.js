...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _myQueries__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./myQueries */ \"./src/js/myQueries.js\");\n\nvar addTodo = _myQueries__WEBPACK_IMPORTED_MODULE_0__.myQuery('.add-todo');\nvar form = _myQueries__WEBPACK_IMPORTED_MODULE_0__.myQuery('#submit-form');\nvar formEdit = _myQueries__WEBPACK_IMPORTED_MODULE_0__.myQuery('#submit-edit-form');\naddTodo.addEventListener('click', function (e) {\n  if (form.classList.contains('d-none')) {\n    e.target.innerHTML = 'Hide Form';\n    form.classList.remove('d-none');\n    formEdit.classList.add('d-none');\n  } else {\n    e.target.innerHTML = '<i class=\"bi bi-plus\"></i>';\n    form.classList.add('d-none');\n    formEdit.classList.add('d-none');\n  }\n\n  form.reset();\n});\n\n//# sourceURL=webpack://JS_ToDoList/./src/js/addTodo.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _assets_style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../assets/style.css */ \"./src/assets/style.css\");\n/* harmony import */ var _myQueries__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./myQueries */ \"./src/js/myQueries.js\");\n/* harmony import */ var _addTodo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./addTodo */ \"./src/js/addTodo.js\");\n/* harmony import */ var _todoItem__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./todoItem */ \"./src/js/todoItem.js\");\n/* harmony import */ var _pushToDom__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pushToDom */ \"./src/js/pushToDom.js\");\n\n\n\n\n // CREATE FIRST PROJECTS\n\nvar projects = [{\n  name: 'Your first project',\n  todoList: [{\n    itemTitle: 'Your first todo',\n    itemDescription: 'Finish this',\n    itemDueDate: new Date(2021, 8, 19),\n    itemPriority: 1,\n    itemStatus: false\n  }]\n}]; // GET FROM STORAGE\n\nvar getProjects = function getProjects() {\n  var storage = JSON.parse(localStorage.getItem('projects'));\n\n  if (storage) {\n    projects = [];\n    projects = projects.concat(storage);\n  }\n}; // ADD PROJECTS TO SUBMIT DROPDOWN\n\n\nvar addProjectsToDropdown = function addProjectsToDropdown() {\n  if (projects) {\n    var select = document.getElementById('projects');\n    select.innerHTML = '';\n    projects.forEach(function (project) {\n      select.add(new Option(project.name));\n    });\n  }\n}; // FIND BUTTONS\n\n\nvar findProjectButtons = function findProjectButtons() {\n  var projectButtons = document.querySelectorAll('.project-btn');\n  projectButtons.forEach(function (projectButton, index) {\n    projectButton.addEventListener('click', function () {\n      var todoItemsList = _myQueries__WEBPACK_IMPORTED_MODULE_1__.myQuery('.todo-items-list');\n      todoItemsList.innerHTML = '';\n      projects[index].todoList.forEach(function (todoList) {\n        todoItemsList.append((0,_pushToDom__WEBPACK_IMPORTED_MODULE_4__.createTodoList)(projects, todoList));\n      });\n      var buttonsDiv = _myQueries__WEBPACK_IMPORTED_MODULE_1__.myQuery('.buttons');\n      buttonsDiv.innerHTML = '';\n      (0,_pushToDom__WEBPACK_IMPORTED_MODULE_4__.clearButton)(projects, projectButton);\n      (0,_pushToDom__WEBPACK_IMPORTED_MODULE_4__.deleteButton)(projects, projectButton);\n    });\n  });\n}; // ADD PROJECT\n\n\nvar addProject = _myQueries__WEBPACK_IMPORTED_MODULE_1__.myQuery('.new-project-btn');\naddProject.addEventListener('click', function (e) {\n  e.preventDefault();\n  var projectName = _myQueries__WEBPACK_IMPORTED_MODULE_1__.myQuery('#new-project').value;\n\n  if (projectName) {\n    var project = {\n      name: projectName,\n      todoList: [],\n      id: new Date()\n    };\n    projects.push(project);\n  }\n\n  addProjectsToDropdown();\n  (0,_pushToDom__WEBPACK_IMPORTED_MODULE_4__.renderProjects)(projects);\n  findProjectButtons();\n  localStorage.setItem('projects', JSON.stringify(projects));\n  addProject.parentNode.parentNode.reset();\n});\n\nvar submitButton = function submitButton() {\n  var submitBtn = _myQueries__WEBPACK_IMPORTED_MODULE_1__.myQuery('.submit-btn-new');\n  submitBtn.addEventListener('click', function (todoData) {\n    todoData.preventDefault();\n    var title = _myQueries__WEBPACK_IMPORTED_MODULE_1__.myQuery('#title').value;\n    var description = _myQueries__WEBPACK_IMPORTED_MODULE_1__.myQuery('#description').value;\n    var dueDate = _myQueries__WEBPACK_IMPORTED_MODULE_1__.myQuery('#due-date').value;\n    var priority = _myQueries__WEBPACK_IMPORTED_MODULE_1__.myQuery('#priority').value;\n    var project = _myQueries__WEBPACK_IMPORTED_MODULE_1__.myQuery('#projects').value;\n    var newTodoItem = (0,_todoItem__WEBPACK_IMPORTED_MODULE_3__.default)(title, description, dueDate, priority, project);\n    projects.find(function (_ref) {\n      var name = _ref.name;\n      return name === newTodoItem.itemProject;\n    }).todoList.push(newTodoItem);\n    var ui = _myQueries__WEBPACK_IMPORTED_MODULE_1__.myQuery('.todo-items-list');\n    ui.appendChild((0,_pushToDom__WEBPACK_IMPORTED_MODULE_4__.createTodoList)(projects, newTodoItem));\n    localStorage.setItem('projects', JSON.stringify(projects));\n  });\n}; // RUN FUNCTIONS\n\n\ngetProjects();\naddProjectsToDropdown();\n(0,_pushToDom__WEBPACK_IMPORTED_MODULE_4__.renderProjects)(projects);\nfindProjectButtons();\nsubmitButton();\n\n//# sourceURL=webpack://JS_ToDoList/./src/js/index.js?");
